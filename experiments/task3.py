...
def run(args):
    ...
    if getattr(args, "plot", False):
        ...
        try:
            ...
            plot_lambda_vs_n(results, list(results.keys()), os.path.join(output_dir, "task3_lambda_n.png"), title="Task 3 (f2): Lambda_n vs n")
            print(f"Saved plot to {os.path.join(output_dir, 'task3_lambda_n.png')}")
            plot_Hn_vs_n(results, list(results.keys()), os.path.join(output_dir, "task3_Hn.png"), title="Task 3 (f2): H_n vs n")
            print(f"Saved plot to {os.path.join(output_dir, 'task3_Hn.png')}")
